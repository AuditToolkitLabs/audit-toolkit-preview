...
**AuditToolkit Linux Security Lite v1.1.1**, a multi-distro Bash audit
...
| Task | Document |
| --- | --- |
| First time? Start here. | [01 — Purpose and Audience](01-purpose-and-audience.md) |
| How to install | [18 — Installation Guide](18-installation-guide.md) |
| How to run an audit | [05 — End-User Guide](05-end-user-guide.md) |
| Set up scheduled audits | [16 — Quick Start: Scheduled Audits](16-quick-start-scheduled-audits.md) |
...
v1.1.1 — published May 2026. Updated 2026-05-03 with signed security documentation release updates.

## Vendor

AuditToolkitLabs (Michael Churchill)
