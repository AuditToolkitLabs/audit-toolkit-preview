...
| RPM package (.rpm) | `audit-toolkit-lite-<version>.noarch.rpm` | RHEL, Fedora, openSUSE, and derivatives; rpm/dnf managed installs. |

Download from:
`https://github.com/AuditToolkitLabs/releases/releases/tag/audit-toolkit-lite/v1.1.1`
...
wget https://github.com/AuditToolkitLabs/releases/releases/download/audit-toolkit-lite/v1.1.1/audit-toolkit-lite-v1.1.1.tar.gz

# Download SHA256SUMS from the v1.1.1 release assets page
# https://github.com/AuditToolkitLabs/releases/releases/tag/audit-toolkit-lite/v1.1.1

# Verify the checksum
sha256sum -c SHA256SUMS --ignore-missing
# Expected output: audit-toolkit-lite-v1.1.1.tar.gz: OK
```

For RPM packages, verify the GPG signature:

```bash
rpm --checksig audit-toolkit-lite-1.1.1.noarch.rpm
```
...
wget https://github.com/AuditToolkitLabs/releases/releases/download/audit-toolkit-lite/v1.1.1/audit-toolkit-lite_1.1.1_all.deb

# Install
sudo dpkg -i audit-toolkit-lite_1.1.1_all.deb
...
```bash
# Download the package
wget https://github.com/AuditToolkitLabs/releases/releases/download/audit-toolkit-lite/v1.1.1/audit-toolkit-lite-1.1.1.noarch.rpm

# Install
sudo rpm -ivh audit-toolkit-lite-1.1.1.noarch.rpm
# Or with dnf (RHEL/Fedora):
sudo dnf localinstall audit-toolkit-lite-1.1.1.noarch.rpm
# Or with zypper (openSUSE):
sudo zypper install audit-toolkit-lite-1.1.1.noarch.rpm
```
...
wget https://github.com/AuditToolkitLabs/releases/releases/download/audit-toolkit-lite/v1.1.1/audit-toolkit-lite-v1.1.1.tar.gz
tar -xzf audit-toolkit-lite-v1.1.1.tar.gz
cd audit-toolkit-lite-v1.1.1/
...
# Expected: AuditToolkit Linux Security Lite v1.1.1
