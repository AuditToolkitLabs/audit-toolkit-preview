...
- API routes: `/api/reports/*`, `/api/webhooks*`, `/api/export/siem`, `/api/trends*`
- CLI commands: `cli.py compliance`, `cli.py siem-export`, `cli.py webhooks`, `cli.py trends`
...
| **Custom audit creation** | Upload proprietary audit scripts for organization-specific controls (e.g., internal standards, compliance requirements) |
...
A: Yes, Enterprise customers can upload custom audit scripts for org-specific controls.
